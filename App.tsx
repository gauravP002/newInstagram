...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between items-center bg-white md:bg-[#fafafa] font-sans">
      <main className="flex-grow flex flex-col items-center justify-center w-full max-w-[350px] pt-4 md:pt-12 px-0 md:px-4">
        ...
        <div className="mt-6 flex flex-col items-center space-y-4">
          ...
          <div className="flex space-x-2">
            <a href="#" className="h-10 transition-transform active:scale-95">
              <img 
